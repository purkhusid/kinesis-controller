...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MinimumThroughputBillingCommitmentOutput) DeepCopyInto(out *MinimumThroughputBillingCommitmentOutput) {
	*out = *in
	if in.EarliestAllowedEndAt != nil {
		in, out := &in.EarliestAllowedEndAt, &out.EarliestAllowedEndAt
		*out = (*in).DeepCopy()
	}
	if in.EndedAt != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MinimumThroughputBillingCommitmentOutput.
func (in *MinimumThroughputBillingCommitmentOutput) DeepCopy() *MinimumThroughputBillingCommitmentOutput {
	if in == nil {
		return nil
	}
	out := new(MinimumThroughputBillingCommitmentOutput)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StreamSpec) DeepCopyInto(out *StreamSpec) {
	*out = *in
	if in.DesiredEncryptionType != nil {
		in, out := &in.DesiredEncryptionType, &out.DesiredEncryptionType
		*out = new(string)
		**out = **in
	}
	if in.DesiredRetentionPeriodHours != nil {
		in, out := &in.DesiredRetentionPeriodHours, &out.DesiredRetentionPeriodHours
		*out = new(int64)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WarmThroughputObject) DeepCopyInto(out *WarmThroughputObject) {
	*out = *in
	if in.CurrentMiBps != nil {
		in, out := &in.CurrentMiBps, &out.CurrentMiBps
		*out = new(int64)
		**out = **in
	}
	if in.TargetMiBps != nil {
		in, out := &in.TargetMiBps, &out.TargetMiBps
		*out = new(int64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WarmThroughputObject.
func (in *WarmThroughputObject) DeepCopy() *WarmThroughputObject {
	if in == nil {
		return nil
	}
	out := new(WarmThroughputObject)
